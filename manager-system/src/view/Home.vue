  ...
  <div>
    <el-container class="home-container">
      ...
      <el-header>
        <el-row>
          <el-col :span="4">
            <p class="system-name">PO集成接口信息管理平台</p>
          </el-col>
          <el-col :offset="12" :span="8" style="min-width: 150px">
            <el-dropdown style="float: right; margin: 20px 10px">
              ...
              >
              80601047 &nbsp;&nbsp;<i class="fa fa-caret-down fa-1x"></i>
              </span>
      ...
      <el-container style="overflow: auto">
        ...
        <el-aside>
          ...
          >
            ...
            <el-menu-item
              index="/interface-info"
              @click="saveActiveNav('/interface-info')"
            >
        ...
        <el-container>
          ...
          <el-footer>Copyright © 2024 Mindray</el-footer>
        </el-container>
      </el-container>
    </el-container>
  </div>
